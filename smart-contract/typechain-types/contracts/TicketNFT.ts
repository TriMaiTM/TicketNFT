...
export interface TicketNFTInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "getOriginalPrice",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "originalPrices",
    values: [BigNumberish]
  ): string;
...
export interface TicketNFT extends BaseContract {
  ...
  getOriginalPrice: TypedContractMethod<
    [tokenId: BigNumberish],
    [bigint],
    "view"
  >;
  ...
  mintTicket: TypedContractMethod<[uri: string], [bigint], "payable">;

  name: TypedContractMethod<[], [string], "view">;

  originalPrices: TypedContractMethod<[arg0: BigNumberish], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "getOriginalPrice"
  ...
  getFunction(
    nameOrSignature: "originalPrices"
